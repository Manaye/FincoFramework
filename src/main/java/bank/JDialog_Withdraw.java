...
public class JDialog_Withdraw extends javax.swing.JDialog
{
	...
	public JDialog_Withdraw(BankFrm parent, String aaccnr, AccountService accountService)
	{
		super(parent);
		parentframe=parent;
		accnr=aaccnr;
	...
	void JButtonOK_actionPerformed(java.awt.event.ActionEvent event)
	{
	     ...
	     accountService.withdraw(accnr,Double.parseDouble(JTextField_AMT.getText()));
		 dispose();
	}
