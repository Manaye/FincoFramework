...
public class JDialog_AddPAcc extends javax.swing.JDialog
{
	...
	public JDialog_AddPAcc(BankFrm parent, AccountService)
	{
		super(parent);
		parentframe=parent;
	...
	void JButtonOK_actionPerformed(java.awt.event.ActionEvent event)
	{
       ...
       String accNum = parentframe.accountn;
       parentframe.clientName=JTextField_NAME.getText();
       String clientName = parentframe.clientName;
       parentframe.street=JTextField_STR.getText();
       String street = parentframe.street;
       parentframe.city=JTextField_CT.getText();
       String city = parentframe.city;
       parentframe.zip=JTextField_ZIP.getText();
       String zip =  parentframe.zip;
       parentframe.state=JTextField_ST.getText();
       String state =   parentframe.state;
	   ...
	   accountService.createPersonalAccount(accNum,clientName,street,city,zip,state);
