...
public class JDialog_AddPAcc extends javax.swing.JDialog
{
	...
	public JDialog_AddPAcc(BankFrm parent, AccountService accountService)
	{
		super(parent);
		parentframe=parent;
	...
	void JButtonOK_actionPerformed(java.awt.event.ActionEvent event)
	{
	       ...
	       String accountNum = JTextField_ACNR.getText(); 
	       parentframe.clientName=JTextField_NAME.getText();
	       String clientName = JTextField_NAME.getText();
	       parentframe.street=JTextField_STR.getText();
	       String street = JTextField_STR.getText();
	       parentframe.city=JTextField_STR.getText();
	       String city = JTextField_STR.getText();
