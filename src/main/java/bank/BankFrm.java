...
public class BankFrm extends javax.swing.JFrame {
	 ...
	 ****/
	String accountnr, clientName, street, city, zip, state, clientType, amountDeposit, dateOfBirth, email, numEmployee;
	boolean newaccount;
...
//        rowdata = new Object[8];
	...
	void JButtonPerAC_actionPerformed(java.awt.event.ActionEvent event) {
		...
		if (newaccount) {
			...
			accountService.createPersonalAccount(accountnr, clientName, accountType, street, city, state, zip, email,
					localDate, AccountClass.PERSONAL);
